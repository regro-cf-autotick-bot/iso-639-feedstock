...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/iso-639-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11531&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/iso-639-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `iso-639` can be installed with:

```
conda install iso-639
```

It is possible to list all of the versions of `iso-639` available on your platform with:
